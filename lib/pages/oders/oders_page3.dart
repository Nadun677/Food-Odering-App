...
import 'package:food_odering_app/pages/dashboard_pages/rest/resturant3.dart';
import 'package:food_odering_app/pages/dashboard_pages/resturant.dart';

class OdersPage3 extends StatelessWidget {
  const OdersPage3({super.key});
        ...
        child: ElevatedButton(
          ...
          onPressed: () {
            Navigator.push(
              context,
              MaterialPageRoute(
                builder: (context) => RestaurantDetailsScreen4(),
              ),
            );
          },
          child: Text(
