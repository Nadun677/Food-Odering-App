...
import 'package:food_odering_app/pages/dashboard_pages/rest/resturant2.dart';
import 'package:food_odering_app/pages/dashboard_pages/resturant.dart';

class OdersPage2 extends StatelessWidget {
  const OdersPage2({super.key});
                ...
                child: Column(
                  ...
                  children: [
                    ...
                    ClipRRect(
                      ...
                      child: Image.asset(
                        'assets/images/9ecb7138-632c-478d-9d17-d55ce3f07f91.jpg',
        ...
        child: ElevatedButton(
          ...
          onPressed: () {
            Navigator.push(
              context,
              MaterialPageRoute(
                builder: (context) => RestaurantDetailsScreen3(),
              ),
            );
          },
          child: Text(
